...
VALUES  (N'MSV001', N'TRẦN THANH THUẬN', N'2345678', 0, CAST(N'1996-01-05' AS Date), N'0754545545', N'HUẾ', CAST(N'2017-06-12' AS Date),               N'MPA1', N'HÌNH 12', N'TRẦN VĂN ', N'111', N'CHA', N'GIÁO VIÊN'),
		...
		(N'MSV008',  N'PHAN TÙNG LÂM', N'206447901', 0, CAST(N'1997-04-15' AS Date), N'0735345345', N'QUẢNG BÌNH', CAST(N'2017-06-12' AS Date),         N'MPA2', N'HINH 1', N'ĐẠI LONG', N'009', N'CHA', N'NÔNG'),
		...
		(N'MSV012', N'PHẠM DUY SƠN', N'44234121', 0, CAST(N'1997-05-10' AS Date), N'0232656232', N'QUẢNG NGÃI', CAST(N'2017-06-12' AS Date),     N'MPA3', N'HÌNH 2', N'ĐÀO HÀ GIANG', N'116', N'MẸ', N'NÔNG'),
		...
		(N'MSV018', N'NGUYỄN VĂN LONG', N'84234121', 0, CAST(N'1999-10-30' AS Date), N'0632323232', N'QUẢNG NAM', CAST(N'2017-06-12' AS Date),     N'MPA4', N'HÌNH 2', N'LƯU TRỌNG NGHĨA', N'116', N'CHA', N'NÔNG'),
		(N'MSV019', N'PHẠM PHƯỚC SƠN', N'84234121', 0, CAST(N'1996-04-19' AS Date), N'0632323232', N'QUẢNG NGÃI', CAST(N'2017-06-12' AS Date),     N'MPA4', N'HÌNH 2', N'PHẠM BIÊN', N'116', N'CHA', N'NÔNG'),
		...
		(N'MSV022', N'LƯƠNG VĂN HIỆP', N'24253535', 1, CAST(N'1997-08-07' AS Date), N'07784937976', N'VŨNG TÀO', CAST(N'2017-06-13' AS Date),        N'MPB1', N'HÌNH 23 ', N'NGUYỄN BÌNH', N'118', N'MẸ', N'CÔNG AN'),
		...
		(N'MSV025', N'HỒ PHƯỚC DANH', N'232617286', 1, CAST(N'1997-03-09' AS Date), N'0167435', N'QUẢNG TRỊ', CAST(N'2017-06-13' AS Date),       N'MPB2', N'HÌNH 17', N'TRƯƠNG THƯ', N'120', N'MẸ', N'NÔNG'),
		...
		(N'MSV027', N'LÝ ĐỊNH THUẬN', N'232617286', 1, CAST(N'1999-06-16' AS Date), N'016754572', N'HUẾ', CAST(N'2017-06-13' AS Date),      N'MPB2', N'HÌNH 17', N'TRƯƠNG THƯ', N'120', N'MẸ', N'NÔNG'),
		(N'MSV028', N'HỒ GIA BẢO', N'232617286', 1, CAST(N'1997-03-27' AS Date), N'016754572', N'QUẢNG BÌNH', CAST(N'2017-06-13' AS Date),      N'MPB2', N'HÌNH 17', N'TRƯƠNG THƯ', N'120', N'MẸ', N'NÔNG'),


		(N'MSV029', N'PHẠM GIA HUY', N'121323', 1, CAST(N'1998-03-05' AS Date), N'082182676546', N'VŨNG TÀU', CAST(N'2017-06-13' AS Date),             N'MPB3', N'HÌH 4', N'PHẠM GIA THÍCH', N'121', N'CHA', N'GIÁO VIÊN'),
		...
		(N'MSV032', N'NGUYỄN CÔNG LỘC', N'2342', 1, CAST(N'1997-04-06' AS Date), N'02424565732', N'ĐÀ NẴNG', CAST(N'2017-06-13' AS Date),            N'MPB3', N'HÌNH 5', N'ĐÀO KHÁNH CHI', N'122', N'MẸ', N'GIÁO VIÊN'),

		(N'MSV033', N'PHẠM GIA DŨNG', N'1213235466', 1, CAST(N'1998-03-05' AS Date), N'08218234573', N'VŨNG TÀU', CAST(N'2017-06-13' AS Date),             N'MPB4', N'HÌH 4', N'NGUYỄN THỊ MƯỜI', N'121', N'MẸ', N'GIÁO VIÊN'),
		(N'MSV034', N'NGUYỄN HOÀI HẢI', N'23425676', 1, CAST(N'1997-04-07' AS Date), N'02424345347', N'GIA LAI', CAST(N'2017-06-13' AS Date),            N'MPB4', N'HÌNH 5', N'PHẠM CHÁNH', N'122', N'CHA', N'GIÁO VIÊN'),
		(N'MSV035', N'NÔNG VĂN THỊNH', N'86225478', 1, CAST(N'1999-04-18' AS Date), N'0242445345', N'KHÁNH HÒA', CAST(N'2017-06-13' AS Date),            N'MPB4', N'HÌNH 5', N'LÊ ĐÌNH VĂN', N'122', N'CHA', N'GIÁO VIÊN'),
		(N'MSV036', N'DƯƠNG ĐÌNH PHƯỚC', N'756254846', 1, CAST(N'1997-04-06' AS Date), N'0242498575', N'GIA LAI', CAST(N'2017-06-13' AS Date),            N'MPB4', N'HÌNH 5', N'NGUYỄN THỊ THU LUYẾN', N'122', N'MẸ', N'GIÁO VIÊN'),
		(N'MSV037', N'NGUYỄN HỮU HƯNG', N'756254846', 1, CAST(N'1999-07-15' AS Date), N'0242498575', N'KHÁNH HÒA', CAST(N'2017-06-13' AS Date),            N'MPB4', N'HÌNH 5', N'PHẠM THỊ HÀO', N'122', N'MẸ', N'GIÁO VIÊN'),
		(N'MSV038', N'TRẦN ANH TUẤN', N'756254846', 1, CAST(N'1997-04-26' AS Date), N'0242498575', N'ĐÀ LẠT', CAST(N'2017-06-13' AS Date),            N'MPB4', N'HÌNH 5', N'ĐỖ ĐÌNH CAO', N'122', N'CHA', N'GIÁO VIÊN'),
		...
		(N'MSV040', N'PHÙNG THANH ĐỘ', N'864564523', 1, CAST(N'1998-04-06' AS Date), N'052324567', N'QUẢNG NAM', CAST(N'2017-06-14' AS Date),            N'MPC1', N'HÌNH 21', N'TRẦN TUẤN', N'124', N'CHUS', N'CHỦ TỊCH'),
		(N'MSV041', N'ĐỊNH HẢI QUỐC', N'45234846', 1, CAST(N'2002-04-17' AS Date), N'0523265764', N'BÌNH THẠNH', CAST(N'2017-06-14' AS Date),          N'MPC1', N'HÌNH 21', N'NGUYỄN THÁI PHIÊN', N'124', N'CHUS', N'CHỦ TỊCH'),
		...
		(N'MSV046', N'LẠI VĂN DUY', N'93291038', 1, CAST(N'1997-06-27' AS Date), N'01672965478', N'ĐIỆN BIÊN', CAST(N'2017-02-05' AS Date),       N'MPC2', N'HÌNH 30', N'PHÙNG ĐÌNH MẠNH', N'126', N'CHA', N'HỌA SĨ'),
		(N'MSV047', N'HUỲNH HẢI HẬU', N'93291038', 1, CAST(N'1997-07-27' AS Date), N'01672965478', N'ĐÀ LẠT', CAST(N'2017-10-23' AS Date),       N'MPC2', N'HÌNH 30', N'NGUYỄN CHÁNH', N'126', N'CHA', N'HỌA SĨ'),
		(N'MSV048', N'LÊ VĂN TÀI', N'93291038', 1, CAST(N'1997-06-27' AS Date), N'01672965478', N'ĐIỆN BIÊN', CAST(N'2017-02-05' AS Date),       N'MPC2', N'HÌNH 30', N'LONG PHÍ', N'126', N'CHA', N'HỌA SĨ'),
		(N'MSV049', N'ĐÀO CHUNG THỦY', N'93291038', 1, CAST(N'1997-11-27' AS Date), N'01672965478', N'SÀI GÒN', CAST(N'2017-02-05' AS Date),       N'MPC2', N'HÌNH 30', N'NGUYỄN CHÁNH', N'126', N'CHA', N'HỌA SĨ'),
		(N'MSV050', N'LÊ THỊ CHUNG', N'93291038', 1, CAST(N'1997-08-27' AS Date), N'01672965478', N'ĐIỆN BIÊN', CAST(N'2017-02-05' AS Date),       N'MPC2', N'HÌNH 30', N'HÀ MÃ ĐÔNG', N'126', N'CHA', N'HỌA SĨ'),

		(N'MSV051', N'LÊ VĂN HOÀ', N'83656355', 1, CAST(N'1999-05-04' AS Date), N'0934546335', N'QUẢNG BÌNH', CAST(N'2017-06-14' AS Date),          N'MPC3', N'HÌNH 27', N'VĂN TÀI', N'125', N'CHA', N'CA SĨ'),
		(N'MSV052', N'NGUYỄN ĐỊNH ', N'3729103845', 1, CAST(N'2022-06-16' AS Date), N'01672965478', N'ĐIỆN BIÊN', CAST(N'2017-02-05' AS Date),     N'MPC3', N'HÌNH 30', N'NGUYỄN CHÁNH', N'126', N'CHA', N'HỌA SĨ'),
		(N'MSV053', N'HUỲNH SƠN NAM', N'6529103875', 1, CAST(N'1999-08-08' AS Date), N'09672965478', N'SÀI GÒN', CAST(N'2017-02-05' AS Date),       N'MPC3', N'HÌNH 30', N'ĐẠI ĐÌNH BA', N'126', N'CHA', N'HỌA SĨ'),
		(N'MSV054', N'NGUYỄN TRẦN TIẾN', N'635291038', 1, CAST(N'1996-06-21' AS Date), N'01472965478', N'ĐIỆN BIÊN', CAST(N'2017-02-05' AS Date),       N'MPC3', N'HÌNH 30', N'NGUYỄN CHÁNH', N'126', N'CHA', N'HỌA SĨ'),

		(N'MSV055', N'LÊ VĂN TRUNG', N'BKJBKB', 1, CAST(N'1999-05-16' AS Date), N'045366355', N'QUẢNG BÌNH', CAST(N'2017-06-14' AS Date),          N'MPC4', N'HÌNH 27', N'VĂN TÀI', N'125', N'CHA', N'CA SĨ'),
		(N'MSV056', N'NGUYỄN BẢO', N'37291038', 1, CAST(N'2001-06-18' AS Date), N'01672965478', N'ĐIỆN BIÊN', CAST(N'2017-02-05' AS Date),     N'MPC4', N'HÌNH 30', N'NGUYỄN CHÁNH', N'126', N'CHA', N'HỌA SĨ'),
		(N'MSV057', N'BÁCH TÙNG LA', N'37291038', 1, CAST(N'1997-06-16' AS Date), N'01672965478', N'SÀI GÒN', CAST(N'2017-03-15' AS Date),       N'MPC4', N'HÌNH 30', N'NGUYỄN CHÁNH', N'126', N'CHA', N'HỌA SĨ'),
		(N'MSV058', N'NGUYỄN ĐẠT', N'75291024', 1, CAST(N'2003-06-26' AS Date), N'01672965478', N'ĐIỆN BIÊN', CAST(N'2017-02-05' AS Date),       N'MPC4', N'HÌNH 30', N'PHƯỚC LONG', N'126', N'CHA', N'HỌA SĨ'),
		(N'MSV059', N'NGUYỄN BẢO', N'37291038', 1, CAST(N'2001-06-18' AS Date), N'01672965478', N'SÀI GÒN', CAST(N'2017-02-05' AS Date),     N'MPC4', N'HÌNH 30', N'NGUYỄN CHÁNH', N'126', N'CHA', N'HỌA SĨ'),
		(N'MSV060', N'BÁCH TÙNG LA', N'37291038', 1, CAST(N'1997-06-16' AS Date), N'01672965478', N'ĐIỆN BIÊN', CAST(N'2017-02-05' AS Date),       N'MPC4', N'HÌNH 30', N'ĐOAN NGỌ', N'126', N'CHA', N'HỌA SĨ'),
		(N'MSV061', N'NGUYỄN ĐẠT', N'75291024', 1, CAST(N'2003-06-26' AS Date), N'01672965478', N'ĐIỆN BIÊN', CAST(N'2017-02-05' AS Date),       N'MPC4', N'HÌNH 30', N'NGUYỄN CHÁNH', N'126', N'CHA', N'HỌA SĨ')
